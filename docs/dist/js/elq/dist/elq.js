...
module.exports = function batchUpdaterMaker(options) {
    ...
    function forceUpdateBatch(updateAsync) {
        ...
        console.log("Forcing update. async: " + updateAsync);
    ...
    function updateBatch() {
        console.log("Updating batch. size: " + batchSize);
...
},{"./batch-updater":84,"./cycle-detector":85,"./extension-handler":87,"./id-generator":88,"./id-handler":89,"./reporter":91,"./utils":92,"element-resize-detector":3}],87:[function(require,module,exports){
